...
function launch_acceptor () {
	...
	local launchcmd="(echo run $acc_id $config_file; cat) | gdb $acceptor_bin"
...
function launch_learner () {
	...
	local launchcmd="(echo run $config_file; cat) | gdb $learner_bin"
...
function launch_client () {
	...
	local launchcmd="(echo run $config_file; cat) | gdb $client_bin"
